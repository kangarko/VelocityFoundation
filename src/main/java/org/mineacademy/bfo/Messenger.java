...
public class Messenger {
	 ...
	 * @param message
	 */
	public void info(final Audience player, final String message) {
	 ...
	 * @param message
	 */
	public void success(final Audience player, final String message) {
	 ...
	 * @param message
	 */
	public void warn(final Audience player, final String message) {
	 ...
	 * @param messages
	 */
	public void error(final Audience player, final String... messages) {
	 ...
	 * @param message
	 */
	public void error(final Audience player, final String message) {
	 ...
	 * @param message
	 */
	public void question(final Audience player, final String message) {
	 ...
	 * @param message
	 */
	public void announce(final Audience player, final String message) {
	 ...
	 */
	private void tell(final Audience player, final String prefix, String message) {
