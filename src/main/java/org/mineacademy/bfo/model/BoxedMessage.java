...
public final class BoxedMessage {
	 ...
	 */
	private final Iterable<? extends Audience> recipients;
	 ...
	 * @param messages
	 */
	private BoxedMessage(Iterable<? extends Audience> recipients, Audience sender, @NonNull String[] messages) {
	 ...
	 * @param sender
	 */
	public void broadcastAs(Audience sender) {
	 ...
	 * @param recipient
	 */
	public void tell(Audience recipient) {
	 ...
	 * @param recipients
	 */
	public void tell(Iterable<? extends Audience> recipients) {
	 ...
	 * @param sender
	 */
	public void tellAs(Audience receiver, Audience sender) {
	 ...
	 * @param sender
	 */
	public void tellAs(Iterable<? extends Audience> receivers, Audience sender) {
	 ...
	 * @param messages
	 */
	public static void tell(Iterable<? extends Audience> recipients, String... messages) {
	 ...
	 * @param messages
	 */
	public static void tell(Audience sender, Audience receiver, String... messages) {
	 ...
	 * @param messages
	 */
	public static void tell(Audience sender, Iterable<? extends Audience> receivers, String... messages) {
