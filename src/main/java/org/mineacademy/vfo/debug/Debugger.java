package org.mineacademy.vfo.debug;
...
public final class Debugger {
	...
	public static void saveError(Throwable t, String... messages) {
		...
		fill(lines,
				...
				header,
				"Running " + SimplePlugin.getServer().getVersion().getVersion() + " and Java " + System.getProperty("java.version"),
				"Plugins: " + Common.join(SimplePlugin.getServer().getPluginManager().getPlugins(), ", ", plugin -> plugin.getDescription().getId()
						+ (plugin.getDescription().getVersion().isPresent() ? " (" + plugin.getDescription().getVersion().get() + ")" : "")),
				"----------------------------------------------------------------------------------------------");
	...
	private static void print(String message) {
		System.out.println(message); // simplicity wins
	}
}
