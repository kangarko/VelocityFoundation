package org.mineacademy.vfo.slider;
...
public final class ColoredTextSlider implements Slider<String> {
	 ...
	 */
	private String primaryColor = CompChatColor.BLACK.toString();

	/**
	 * The colorized text color. Defaults to dark red.
	 */
	private String secondaryColor = CompChatColor.DARK_RED.toString();
	...
	/**
	 * @see org.mineacademy.vfo.slider.Slider#next()
	 */
	@Override
	public String next() {
