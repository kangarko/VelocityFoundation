...
import org.mineacademy.vfo.settings.ConfigItems;
...
public final class Variable extends YamlConfig {
	...
	/**
	 * @see org.mineacademy.vfo.settings.YamlConfig#onLoad()
	 */
	@Override
	 ...
	 * @return
	 */
	public SimpleComponent build(Audience sender, SimpleComponent existingComponent, Map<String, Object> replacements) {
	...
	/**
	 * @see org.mineacademy.vfo.settings.YamlConfig#equals(java.lang.Object)
	 */
	@Override
