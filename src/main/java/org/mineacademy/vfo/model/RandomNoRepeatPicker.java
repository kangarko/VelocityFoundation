...
public abstract class RandomNoRepeatPicker<T> {
	 ...
	 * @return
	 */
	public T pickFromFor(final Iterable<T> items, final Audience player) {
	 ...
	 * @return
	 */
	public T pickRandom(final Audience player) {
	 ...
	 * @return
	 */
	protected abstract boolean canObtain(Audience player, T picked);
	 ...
	 * @return
	 */
	public static final <T> RandomNoRepeatPicker<T> newPicker(final BiFunction<Audience, T, Boolean> canObtain) {
		return new RandomNoRepeatPicker<T>() {

			@Override
			protected boolean canObtain(final Audience player, final T picked) {
