 ...
 */
package org.mineacademy.vfo.metrics;
...
public class Metrics {
	...
	public static class MetricsBase {
		...
		public MetricsBase(
			...
			final ScheduledThreadPoolExecutor scheduler = new ScheduledThreadPoolExecutor(1, task -> new Thread(task, "bStats-Metrics"));
